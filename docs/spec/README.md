...
`thesis-intelligence.md` owns the 0.3 product/analytical semantics. `thesis-intelligence-contracts-v1.md` freezes the exact v1 schemas and method boundaries that implementation must follow.
